...
def insert_search_hits(soup, logger, str_search_div ):
    ...
    #<script>
     #                   document.getElementById('close-results').addEventListener('click', function() {
      #                      document.getElementById('dropdown-container').classList.add('is-hidden');
       #                 });
        #            </script>
        ...
        dropdown_html = f"""
            <div id="dropdown-container" class="notification is-flex is-flex-direction-column is-justify-content-space-between is-paddingless is-hidden is-full">
                        ...
                        <div id="dropdown-content" 
                           class="is-flex is-justify-content-flex-end  is-paddingless is-half-desktop is-half-widescreen is-pulled-right ml-auto">
                        <!-- Search results will be injected here by InstantSearch.js -->
                        <div id="hits" class="is-flex-grow-1 is-flex is-flex-direction-column is-align-items-stretch">
                        </div>
                    </div>
                    <div id="dropdown-footer" 
                        class="is-hidden has-text-centered is-flex is-justify-content-center is-align-items-center">
