...
def insert_search_hits(soup, logger, str_search_div ):
    ...
    if searchparent:   
        ...
        dropdown_html = f"""
            <div id="dropdown-container" class="notification is-hidden">
                <button id="close-results" class="delete  ais-SearchBox-reset"></button>
                <div id="dropdown-content"  class="ais-Carousel-list">
                <div id="hits" class="">
                </div>
